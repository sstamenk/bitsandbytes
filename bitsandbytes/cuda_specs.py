...
def get_cuda_version_tuple() -> Optional[tuple[int, int]]:
    ...
    try:
        if torch.version.cuda:
            ...
            # Prefer torch.version.rocm which reports the real ROCm version.
            # torch.version.hip reports the HIP SDK version which diverged
            # from the ROCm version starting with ROCm 7.x
